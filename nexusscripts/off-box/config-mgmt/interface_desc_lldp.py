...
:Box Type:Off-Box
:Title:Interface Description configuration's edited   
:Short Description:To dynamically configure interface description's
:Long Description:Check the CDP state and modify the interface description's accordingly.
:Input:command to check the CDP state and based on the command outpu'st,
       modify the description of the interface
:Output:interface description should be updat'sed
"""
