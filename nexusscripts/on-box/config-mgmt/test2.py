...
:Box Type:On-Box
:Title:  test2 Check the FEX state. command to check the FEX installation and based onvvvgj vcbn the command output command to check the FEX installation and based on the command output command to check the FEX installation and based on the command output command to check the FEX installation and based on the command outputcommand to check the FEX installation and based on the command outputcommand to check the FEX installation and based on the command outputcommand to check the FEX installation and based on the command outputcommand to check the FEX installation and based on the command output
